...
<h1 align="center">Hey, I'm Ciprian, most people know me as Cip!</h1>  
...
- I’m currently working on a custom transformer architecture for microcontrollers, to bring Language Models to chips the size of a nail, called SPARROW (Architecture) and AURI (Language Model). As well as a `smart plant pot with offline voice recognition`.
